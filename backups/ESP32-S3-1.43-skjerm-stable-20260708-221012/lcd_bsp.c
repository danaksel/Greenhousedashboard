...
static const uint32_t GREENHOUSE_METRIC_TEXT = 0xD0DEC8;
static const uint32_t GREENHOUSE_METRIC_TITLE = 0x7B8A70;
...
static const char *GREENHOUSE_APP_VERSION = "v0.10.7";
...
static void greenhouse_set_slide_1_theme(uint32_t bg_color, uint32_t title_color, uint32_t value_color, uint32_t aux_color, const void *image_src);
...
static void greenhouse_ui_create(void)
{
  ...
  lv_obj_set_style_bg_color(settings_bottom, lv_color_hex(0xA9B79F), 0);
  ...
  lv_obj_set_style_text_color(settings_title, lv_color_hex(0xDCE8D4), 0);
  ...
  lv_obj_set_style_text_color(greenhouse_version_label, lv_color_hex(0x5F714F), 0);
  ...
  lv_obj_set_style_text_color(brightness_title, lv_color_hex(0xD28C31), 0);
  ...
  lv_obj_set_style_bg_color(greenhouse_brightness_slider, lv_color_hex(0x050805), LV_PART_MAIN);
  ...
  lv_obj_set_style_bg_color(greenhouse_brightness_slider, lv_color_hex(0xD28C31), LV_PART_KNOB);
  ...
  lv_obj_set_style_text_color(greenhouse_brightness_value_label, lv_color_hex(0xDCE8D4), 0);
  ...
  lv_obj_set_style_text_color(rotation_title, lv_color_hex(0xD28C31), 0);
  ...
  lv_obj_set_style_bg_color(rotation_toggle, lv_color_hex(0x5F714F), 0);
  ...
  lv_obj_set_style_bg_color(greenhouse_rotation_toggle_knob, lv_color_hex(0xD28C31), 0);
  ...
  lv_obj_set_style_text_color(greenhouse_settings_clock_label, lv_color_hex(0x2D3A21), 0);
  ...
  lv_obj_set_style_text_color(ssid_title, lv_color_hex(0x2D3A21), 0);
  ...
  lv_obj_set_style_text_color(greenhouse_wifi_ssid_label, lv_color_hex(0x000000), 0);
  ...
  lv_obj_set_style_text_color(signal_title, lv_color_hex(0x2D3A21), 0);
  ...
  lv_obj_set_style_text_color(greenhouse_wifi_rssi_label, lv_color_hex(0x000000), 0);
  ...
  lv_obj_set_style_bg_color(settings_close, lv_color_hex(0x2D3A21), 0);
  ...
  lv_obj_set_style_border_color(greenhouse_refresh_toast, lv_color_hex(0x8FE0A4), 0);
  ...
  lv_obj_set_style_text_color(greenhouse_boot_status_label, lv_color_hex(0xA9B79F), 0);
...
static void greenhouse_show_page(uint8_t page_index)
{
  greenhouse_page_index = page_index > 1 ? 1 : page_index;
...
static void greenhouse_refresh_toast_timer_cb(lv_timer_t *timer)
{
  ...
  else if (greenhouse_page_2 != NULL)
  {
...
static void greenhouse_page_event_cb(lv_event_t *event)
{
  ...
  if (abs_dy > 48 && abs_dy > abs_dx)
  {
    if (dy < 0)
    {
      ...
      greenhouse_show_refresh_toast("Oppdaterer...", 0xFFB36B, false);
    }
    else
    {
  ...
  {
    greenhouse_show_page(greenhouse_page_index == 0 ? 1 : 0);
  }
}
...
static void greenhouse_update_settings_clock(void)
{
  ...
  if (time_text == NULL || time_text[0] == '\0')
  {
    ...
    lv_obj_set_style_text_color(greenhouse_settings_clock_label, lv_color_hex(0xA9B79F), 0);
    return;
  }
  ...
  lv_obj_set_style_text_color(greenhouse_settings_clock_label,
                              strcmp(time_text, "--:--:--") == 0 ? lv_color_hex(0x5F714F) : lv_color_hex(0x2D3A21),
                              0);
}
...
static void greenhouse_update_rotation_lock_label(void)
{
  ...
  {
    lv_obj_set_style_text_color(greenhouse_rotation_free_label, locked ? lv_color_hex(0xA9B79F) : lv_color_hex(0xF1ECEC), 0);
  }
  if (greenhouse_rotation_locked_label != NULL)
  {
    lv_obj_set_style_text_color(greenhouse_rotation_locked_label, locked ? lv_color_hex(0xF1ECEC) : lv_color_hex(0xA9B79F), 0);
  }
}
...
static void greenhouse_set_fetching_labels(void)
{
  if (greenhouse_updated_label_1 != NULL)
  {
    ...
    lv_obj_set_style_text_color(greenhouse_updated_label_1, lv_color_hex(0xFFB36B), 0);
  }
  if (greenhouse_updated_label_2 != NULL)
  {
    greenhouse_label_set_text(greenhouse_updated_label_2, "HENTER");
    lv_obj_set_style_text_color(greenhouse_updated_label_2, lv_color_hex(0xFFB36B), 0);
  }
}
...
static void greenhouse_set_updated_label(lv_obj_t *label, const char *updated_at, int data_age_seconds, int wifi_connected)
{
  ...
  lv_color_t status_color = lv_color_hex(0x8FE0A4);
  if (wifi_connected == 0)
  {
    status = "Offline:";
    status_color = lv_color_hex(0xFF987D);
  }
  else if (data_age_seconds < 0)
  {
    status = "Venter:";
    status_color = lv_color_hex(0xA9B79F);
  }
  else if (data_age_seconds > 300)
  {
    status = "Gammel:";
    status_color = lv_color_hex(0xFFB36B);
  }
...
static void greenhouse_apply_temperature_theme(float temp_c)
{
  if (isnan(temp_c))
  {
    greenhouse_set_slide_1_theme(0x2D3A21, 0xD28C31, 0xADBCA2, 0x5F714F, &image_mild);
  }
  else if (temp_c > 28.0f)
  {
    greenhouse_set_slide_1_theme(0xC14913, 0xFCA22E, 0xF1ECEC, 0xFCA22E, &image_hot);
  }
  else if (temp_c >= 23.0f)
  {
    greenhouse_set_slide_1_theme(0xD28C31, 0x5F714F, 0x2D3A21, 0x5F714F, &image_warm);
  }
  else if (temp_c < 12.0f)
  {
    greenhouse_set_slide_1_theme(0x5190A1, 0x245046, 0x9FD9E4, 0x245046, &image_cold);
  }
  else
  {
    greenhouse_set_slide_1_theme(0x2D3A21, 0xD28C31, 0xADBCA2, 0x5F714F, &image_mild);
...
static void greenhouse_set_slide_1_theme(uint32_t bg_color, uint32_t title_color, uint32_t value_color, uint32_t aux_color, const void *image_src)
{
  ...
  {
    lv_obj_set_style_text_color(greenhouse_temp_title_label, lv_color_hex(title_color), 0);
  }
  if (greenhouse_humidity_title_label != NULL)
  {
    lv_obj_set_style_text_color(greenhouse_humidity_title_label, lv_color_hex(title_color), 0);
  }
  if (greenhouse_temp_label != NULL)
  {
    lv_obj_set_style_text_color(greenhouse_temp_label, lv_color_hex(value_color), 0);
  }
  if (greenhouse_humidity_label != NULL)
  {
    lv_obj_set_style_text_color(greenhouse_humidity_label, lv_color_hex(value_color), 0);
  }
  if (greenhouse_temp_unit_label != NULL)
  {
    lv_obj_set_style_text_color(greenhouse_temp_unit_label, lv_color_hex(value_color), 0);
  }
  if (greenhouse_humidity_unit_label != NULL)
  {
    lv_obj_set_style_text_color(greenhouse_humidity_unit_label, lv_color_hex(value_color), 0);
  }
  if (greenhouse_updated_label_1 != NULL)
  {
...
static void greenhouse_update_dashboard(lv_timer_t *timer)
{
  ...
  if (door_is_closed < 0)
  {
    ...
    lv_obj_set_style_text_color(greenhouse_door_status_label, lv_color_hex(0xA9B79F), 0);
  }
  ...
  else
  {
    ...
    lv_obj_set_style_text_color(greenhouse_door_status_label, lv_color_hex(0xFFB36B), 0);
  }
  ...
  if (windows_open < 0)
  {
    ...
    lv_obj_set_style_text_color(greenhouse_window_status_label, lv_color_hex(0xA9B79F), 0);
  }
  ...
  else if (heating_on < 0 && fan_on < 0)
  {
    ...
    lv_obj_set_style_text_color(greenhouse_climate_status_label, lv_color_hex(0xA9B79F), 0);
  }
  else
  {
    lv_img_set_src(greenhouse_climate_icon, &fan_off);
  ...
  if (wifi_connected > 0)
  {
    ...
    lv_obj_set_style_text_color(greenhouse_wifi_status_label, lv_color_hex(0x8FE0A4), 0);
  }
  else
  {
    greenhouse_label_set_text(greenhouse_wifi_status_label, "IKKE TILKOBLET");
    lv_obj_set_style_text_color(greenhouse_wifi_status_label, lv_color_hex(0xFF987D), 0);
  }
  ...
  else
  {
    ...
    lv_obj_set_style_text_color(greenhouse_wifi_rssi_label, lv_color_hex(0x2D3A21), 0);
  }
}
